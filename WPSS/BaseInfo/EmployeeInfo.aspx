    ...
    function f13100302(obj, obj1) {
        ...
        if (navigator.userAgent.indexOf("Chrome") > 0) {
            ...
            if (document.getElementById("come").value == "se") {
                window.opener.document.getElementById("Text4").value = obj;
                window.opener.document.all("Label1").innerText = obj1;
            }
            else if (document.getElementById("come").value == "pu") {
                window.opener.document.getElementById("Text4").value = obj;
                window.opener.document.all("Label1").innerText = obj1;
            }
            ...
            else if (document.getElementById("come").value == "or") {
                window.opener.document.getElementById("Text10").value = obj;
                window.opener.document.all("Label1").innerText = obj1;
            }
            ...
            else if (document.getElementById("come").value == "tr") {
                window.opener.document.getElementById("Text4").value = obj;
                window.opener.document.all("Label1").innerText = obj1;
            }
            else if (document.getElementById("come").value == "us") {
                window.opener.document.getElementById("Text3").value = obj;
                window.opener.document.all("Label1").innerText = obj1;
