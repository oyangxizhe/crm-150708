    ...
    function f13100302(obj, obj1, obj2, obj3) {
        ...
        if (navigator.userAgent.indexOf("Chrome") > 0) {
            ...
            if (document.getElementById("come").value == "pu") {
                window.opener.document.getElementById("COKEY").value = obj;
                window.opener.document.getElementById("Text14").value = obj1;
                window.opener.document.getElementById("Text15").value = obj2;
                window.opener.document.getElementById("Text16").value = obj3;
            }
