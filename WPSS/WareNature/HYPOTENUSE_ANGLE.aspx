<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HYPOTENUSE_ANGLE.aspx.cs" Inherits="WPSS.WareNature.HYPOTENUSE_ANGLE" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>金手指斜边角度维护</title>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("HYPOTENUSE_ANGLE") %>');">选取</a>
                   </ItemTemplate>
              ...
              <asp:TemplateField HeaderText="删除" >
                <ItemTemplate >
                 ...
                 <ItemStyle Width="40px"  />
                    ...
                    <asp:TemplateField HeaderText="金手指斜边角度">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("HYPOTENUSE_ANGLE") %>'></asp:LinkButton>                     
                </ItemTemplate>
