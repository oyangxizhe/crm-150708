<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ASSIGN_STACKUP.aspx.cs" Inherits="WPSS.WareNature.ASSIGN_STACKUP" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("ASSIGN_STACKUP") %>');">选取</a>
                   </ItemTemplate>
              ...
              <asp:TemplateField HeaderText="删除" >
                <ItemTemplate >
                 ...
                 <ItemStyle Width="40px"  />
                    ...
                    <asp:TemplateField HeaderText="指定叠构">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("ASSIGN_STACKUP") %>'></asp:LinkButton>                     
                </ItemTemplate>
