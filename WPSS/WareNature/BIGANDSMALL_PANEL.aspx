<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BIGANDSMALL_PANEL.aspx.cs" Inherits="WPSS.WareNature.BIGANDSMALL_PANEL" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("BIGANDSMALL_PANEL") %>');">选取</a>
                   </ItemTemplate>
              ...
              <asp:TemplateField HeaderText="删除" >
                <ItemTemplate >
                 ...
                 <ItemStyle Width="40px"  />
                    ...
                    <asp:TemplateField HeaderText="超大小板维护">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("BIGANDSMALL_PANEL") %>'></asp:LinkButton>                     
                </ItemTemplate>
