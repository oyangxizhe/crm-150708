<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PLANK_THICKNESS.aspx.cs" Inherits="WPSS.WareNature.PLANK_THICKNESS" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("Plank_Thickness") %>');">选取</a>
                   </ItemTemplate>
              ...
              <asp:TemplateField HeaderText="删除" >
                ...
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("Plank_Thickness") %>'></asp:LinkButton>                     
                </ItemTemplate>
