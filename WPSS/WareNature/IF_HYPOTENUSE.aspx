<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IF_HYPOTENUSE.aspx.cs" Inherits="WPSS.WareNature.IF_HYPOTENUSE" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("IF_HYPOTENUSE") %>');">选取</a>
                   </ItemTemplate>
              ...
              <asp:TemplateField HeaderText="删除" >
                <ItemTemplate >
                 ...
                 <ItemStyle Width="40px"  />
                    ...
                    <asp:TemplateField HeaderText="金手指斜边维护">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("IF_HYPOTENUSE") %>'></asp:LinkButton>                     
                </ItemTemplate>
