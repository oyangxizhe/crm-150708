<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BIGANDSMALL_PANELT.aspx.cs" Inherits="WPSS.WareNature.BIGANDSMALL_PANELT" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑超大小板信息</title>
...
<input id="Text1" type="text"  runat="server"   readonly ="readonly" class ="c14031401" /> 
     ...
     <div class="c13101904" id ="Div6">
      ...
      <asp:ListItem ></asp:ListItem>
       <asp:ListItem >超大板</asp:ListItem>
        <asp:ListItem>超小板</asp:ListItem>
                    <asp:ListItem>正常板</asp:ListItem>
                    </asp:DropDownList> 
         <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="DropDownList2" Text="必填的！" runat="server" /></div>
                  <div class="c13101903" id ="Div29">
                   基准 </div>
     <div class="c13101904" id ="Div3">
<input id="Text3" type="text"  runat="server"   class ="c14031401" /> 
 
         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="Text3" Text="必填的！" runat="server" /></div>
           </div>
