...
<div class ="c13101905">
  ...
  <div id="i15013001" class ="c13110501">
   ...
   <span class="c13110511" id ="Span6">
    ...
    <asp:LinkButton ID="btnReconcile" runat="server" onclick="btnReconcile_Click" CssClass ="">产生应付款作业</asp:LinkButton>
    </span> 
   </div>
...
<div id="i14073101" class ="c15012901">
   ...
   <asp:TemplateField HeaderText="入库(退货)单号">
      ...
      <asp:TemplateField HeaderText="入库退货数量">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox51" runat="server" Text='<%#Eval("入库退货数量") %>' CssClass ="c14071615" ></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="4%" />
                 <ItemStyle Width="4%"/>
            </asp:TemplateField>
