      ...
      <script type ="text/javascript" >
          ...
          function f13100202(obj, obj1) {
              ...
              if (navigator.userAgent.indexOf("Chrome") > 0) {
                  ...
                  if (obj == "Text3") {
                      var url = "../BaseInfo/employeeinfo.aspx?come=us";
                      var dlgResult = myShowModalDialog(url, window, 900, 500);
                  }
                  else if (obj == "Text5") {
                      var url = "../BaseInfo/depart.aspx?come=us";
                      var dlgResult = myShowModalDialog(url, window, 900, 500);
                  }
              }
              else {
                  if (obj == "Text3") {
                      ...
                      dlgResult = window.showModalDialog("../BaseInfo/depart.aspx", window, "dialogWidth:970px; dialogHeight:490px; status:0;");
                      if (dlgResult != undefined) {
