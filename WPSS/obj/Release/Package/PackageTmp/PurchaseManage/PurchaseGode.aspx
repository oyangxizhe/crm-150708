<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseGode.aspx.cs" Inherits="WPSS.PurchaseManage.PurchaseGode" EnableEventValidation="false" %>
             ...
             <asp:TemplateField HeaderText="入库单号">
                <ItemTemplate >
                 ...
                 <asp:BoundField DataField="PUID" HeaderText="采购单号" >
                          ...
                          <asp:BoundField DataField="GECOUNT" HeaderText="入库数量" >
                              <ItemStyle Width="100px"  ForeColor="#595d5a"/>
                                    <HeaderStyle Width="100px" HorizontalAlign="Center" />
                          </asp:BoundField>
