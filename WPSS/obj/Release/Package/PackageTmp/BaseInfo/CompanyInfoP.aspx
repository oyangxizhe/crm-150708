        ...
        if (navigator.userAgent.indexOf("Chrome") > 0) {
            ...
            var table = window.opener.document.getElementById('<%=GridView1.ClientID%>');
               ...
               for (i = 1; i < tr.length; i++) {
                   if (objx == i) {
                       tr[i].getElementsByTagName("td")[0].getElementsByTagName("input")[0].value = obj1;//
                       tr[i].getElementsByTagName("td")[1].getElementsByTagName("input")[0].value = obj2;//
                       tr[i].getElementsByTagName("td")[2].getElementsByTagName("input")[0].value = obj3;//
                       tr[i].getElementsByTagName("td")[3].getElementsByTagName("input")[0].value = obj4;//
