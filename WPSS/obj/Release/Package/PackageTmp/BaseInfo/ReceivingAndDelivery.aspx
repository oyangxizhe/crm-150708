    ...
    function f13100302(obj, obj1, obj2, obj3, obj4) {
        ...
        if (navigator.userAgent.indexOf("Chrome") > 0) {
            ...
            if (document.getElementById("come").value == "pu") {
                window.opener.document.getElementById("RDID").value = obj;
                window.opener.document.getElementById("Text12").value = obj2;
                window.opener.document.getElementById("Text13").value = obj4;
            }
