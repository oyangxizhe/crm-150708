   ...
   <span class="c13110511" id ="Span8">
    ...
    <asp:LinkButton ID="btnReductionReconcil" runat="server" onclick="btnReductionReconcile_Click" CssClass ="">对帐还原</asp:LinkButton>
     ...
     <asp:ImageButton ID="btnPrint" 
                 ...
                 <div class="c13110510" id ="Div49" style ="display :none ">
...
<input id="Text1" type="text"  runat="server"   readonly ="readonly" class="c14112011"
   ...
   <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="Text2" Text="必填的！" runat="server" /></div>
              ...
              <asp:TemplateField HeaderText="前置天数">
               ...
               <HeaderStyle Width="15%" />
                 <ItemStyle Width="15%"  ForeColor="#595d5a"/>
                      ...
                      <asp:TemplateField HeaderText="层数"  >
                <ItemTemplate >
     ...
     <script type ="text/javascript" >
         ...
         function f13100202(obj, obj1) {
             ...
             if (obj == "Text2") {
                 ...
                 var url = "../SellManage/Customerinfo.aspx?come=or";
                 //传入参数示例
                 ...
                 var url = "../BaseInfo/Wareinfo.aspx?obj1=" + obj1 + "";
                 var dlgResult = myShowModalDialog(url, window, 900, 500);
                 if (navigator.userAgent.indexOf("Chrome") > 0) {
                  ...
                  var url = "../BaseInfo/EMPLOYEEINFO.aspx?come=or";
                  var dlgResult = myShowModalDialog(url, window, 900, 500);
                  if (navigator.userAgent.indexOf("Chrome") > 0) {
