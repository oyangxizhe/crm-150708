<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CuReconcile.aspx.cs" Inherits="WPSS.SellManage.CuReconcile" EnableEventValidation="false" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("对账单号") %>');">选取</a>
                   </ItemTemplate>
             ...
             <asp:TemplateField HeaderText="对账单号">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("对账单号") %>'></asp:LinkButton>                     
                </ItemTemplate>
                 <HeaderStyle Width="6%"  />
