<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="WPSS.SellManage.Order" EnableEventValidation="false"%>
                ...
                <ItemTemplate >
                 ...
                 <ItemStyle Width="4%"  ForeColor="#595d5a"/>
                         ...
                         <asp:BoundField DataField="ORDERDATE" HeaderText="订单日期" >
                           ...
                           <asp:BoundField DataField="OCOUNT" HeaderText="订单数量" >
                              <ItemStyle Width="4%" ForeColor="#595d5a" />
                                    <HeaderStyle HorizontalAlign="Center" Width="4%" />
                          </asp:BoundField>
