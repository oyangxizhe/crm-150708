<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BGA_DESIGN.aspx.cs" Inherits="WPSS.WareNature.BGA_DESIGN" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("BGA_DESIGN") %>');">选取</a>
                   </ItemTemplate>
              ...
              <asp:TemplateField HeaderText="删除" >
                <ItemTemplate >
                 ...
                 <ItemStyle Width="40px"  />
                    ...
                    <asp:TemplateField HeaderText="BGA设计维护">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("BGA_DESIGN") %>'></asp:LinkButton>                     
                </ItemTemplate>
