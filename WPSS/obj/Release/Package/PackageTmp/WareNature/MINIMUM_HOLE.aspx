<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MINIMUM_HOLE.aspx.cs" Inherits="WPSS.WareNature.MINIMUM_HOLE" %>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("MINIMUM_HOLE") %>');">选取</a>
                   </ItemTemplate>
              ...
              <asp:TemplateField HeaderText="删除" >
                ...
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("MINIMUM_HOLE") %>'></asp:LinkButton>                     
                </ItemTemplate>
