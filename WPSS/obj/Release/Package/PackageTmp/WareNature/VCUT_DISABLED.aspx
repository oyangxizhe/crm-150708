<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VCUT_DISABLED.aspx.cs" Inherits="WPSS.WareNature.VCUT_DISABLED" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>V-cut 残厚维护</title>
...
<span  class ="c13102102"><asp:Label ID="prompt" runat="server"  ForeColor="#f80707"></asp:Label></span>
               ...
               <asp:GridView ID="GridView1" runat="server" 
                   ...
                   <ItemTemplate>
         <a href ="javascript:f13100302('<%#Eval ("VCUT_DISABLED") %>');">选取</a>
                   </ItemTemplate>
              ...
              <asp:TemplateField HeaderText="删除" >
                <ItemTemplate >
                 ...
                 <ItemStyle Width="40px"  />
                    ...
                    <asp:TemplateField HeaderText="V-cut 残厚">
                <ItemTemplate >
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Select" 
                        Text='<%# Bind("VCUT_DISABLED") %>'></asp:LinkButton>                     
                </ItemTemplate>
