               ...
               <asp:GridView ID="GridView1" runat="server" 
                    ...
                    onrowdatabound="GridView1_RowDataBound" 
                        ...
                        AutoGenerateColumns="False" PageSize="15" 
                         CssClass ="c13102001" OnRowEditing="GridView1_RowEditing"
...
<script type="text/javascript" language="javascript">
    function f13100302(obj,obj1,obj2,obj3,obj4,obj5,obj6,obj7,obj8,obj9,obj10) {
        ...
        if (navigator.userAgent.indexOf("Chrome") > 0) {
                ...
                window.opener.document.getElementById("Text6").value = obj4;
                window.opener.document.getElementById("Text7").value = obj5;
                window.opener.document.getElementById("Text8").value = obj6;
                window.opener.document.getElementById("Text9").value = obj7;
                window.opener.document.getElementById("Text10").value = obj8;
                window.opener.document.getElementById("Text11").value = obj9;
                window.opener.document.getElementById("Text12").value = obj10;
                window.opener.document.getElementById("Text13").focus()
                window.close();
        }
