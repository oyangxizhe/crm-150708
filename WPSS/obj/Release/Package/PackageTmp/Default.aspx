...
<meta name ="keywords" content ="客户关系管理系统,客户关系管理软件,ERP,小微企业管理系统,希哲软件" />
    ...
    <input id="hint" type="hidden"  runat="server" />
        ...
        <div style="height:360px;margin-top:40px; margin-bottom:0px;">
            <div style="width:45%; float:left; border-right:solid 1px #ccc; height:100%; text-align:right; padding-right:30px;">
                <br />
                <br />
                <img id="Img1" src="Image/logo_index.png" runat=server /><br />
          
                <div style ="display :none "><img src="image/logo.jpg" alt ="" /></div>
                      <div style=" color :#990033 "> <div><img src="image/logo2.png" alt ="" /></div></div>
        ...
        <div style =" float :left ; width:97%; height :7%; margin-bottom :2%;  margin-left :3%;">登陆CRM MS管理系统</div>
      <div  class ="c14112101">
                       <div class="c14112102">用户名</div>
                       <div class="c14112103"> 
                           <input id="Text1" type="text" runat ="server" class ="c1312050201" /></div>
                       
                      <div id="i13102301" style =" color :Red ;  width:56%; height :7%"> <asp:Label ID="prompt" runat="server" ></asp:Label></div>
                      ...
                      <div id="Div1" style =" color :Red ; margin-left :8.8%; width:56%; height :7%"> </div>
                      </div>
