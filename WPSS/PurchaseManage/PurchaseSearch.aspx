<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseSearch.aspx.cs" Inherits="WPSS.PurchaseManage.PurchaseSearch" EnableEventValidation="false"%>
    ...
    function f13100202(obj) {
        ...
        if (navigator.userAgent.indexOf("Chrome") > 0) {
            if (obj == "StartDate") {
                ...
                var url = "../PurchaseManage/Supplierinfo.aspx";
                var dlgResult = myShowModalDialog(url, window, 960,480);
            }
        }
        else {
            if (obj == "StartDate") {
