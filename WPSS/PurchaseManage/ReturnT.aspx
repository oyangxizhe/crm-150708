...
<div class ="c13111602" id="i13122801">
     ...
     <div class="c13122801" id ="Div36">
      <span style="color :#990033; margin-left :100px">
         注：由于退货含只退货金额不退货数量的需求，所以退货未税金额，退货税额，退货含税金额都需用户自己输入。退货数量与退货金额无直接关联</span>
</div>
 <asp:GridView ID="GridView1" runat="server" 
           ...
           <asp:TemplateField HeaderText="ID" >
             ...
             <asp:TemplateField HeaderText="退货未税" >
                <ItemTemplate >
                 <asp:TextBox ID="TextBox23" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "退货未税金额", "{0:F2}")%>'  CssClass ="c13112012" ></asp:TextBox>                     
                </ItemTemplate>
                    <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  />
            </asp:TemplateField> 
                       <asp:TemplateField HeaderText="退货税额">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox24" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "退货税额", "{0:F2}")%>'  CssClass ="c13112012"></asp:TextBox>                     
                </ItemTemplate>
                   <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  />
            </asp:TemplateField> 
                       <asp:TemplateField HeaderText="退货含税">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox25" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "退货含税金额", "{0:F2}")%>'   CssClass ="c13112012"></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  />
            </asp:TemplateField> 
        ...
        <asp:TemplateField HeaderText="物料编码">
                ...
                <ItemTemplate >
                 ...
                 <ItemStyle Width="3%"  ForeColor="#595d5a"/>
                        ...
                        <asp:TemplateField HeaderText="本退货单累计退货数量">
                <ItemTemplate >
