...
<script type="text/javascript" language="javascript">
    function f13100302(obj, obj1, obj2, obj3, obj4) {
        ...
        if (navigator.userAgent.indexOf("Chrome") > 0) {
            if (document.getElementById("come").value == "pu") {
                window.opener.document.getElementById("Text2").value = obj;
                window.opener.document.getElementById("Text5").value = obj1;
                window.opener.document.getElementById("Text6").value = obj2;
                window.opener.document.getElementById("Text10").value = obj3;
                window.opener.document.getElementById("Text11").value = obj4;
            }
            else if (document.getElementById("come").value == "pg") {
                window.opener.document.getElementById("suid").value = obj;
                window.opener.document.getElementById("Text5").value = obj1;
            }
            else if (document.getElementById("come").value == "pp") {
                window.opener.document.getElementById("Text6").value = obj1;
            }
            else if (document.getElementById("come").value == "ap") {
                window.opener.document.getElementById("Text2").value = obj;
                window.opener.document.getElementById("Text3").value = obj1;
                window.opener.document.getElementById("Text4").focus();
            }
            else if (document.getElementById("come").value == "sn") {
                window.opener.document.getElementById("Text2").value = obj1;
            }
            else if (document.getElementById("come").value == "purchase_reconcile") {
                window.opener.document.getElementById("Text1").value = obj1;
            }
            window.close();
        }
