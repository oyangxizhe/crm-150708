    ...
    function f13100302(obj, obj1) {
        ...
        if (navigator.userAgent.indexOf("Chrome") > 0) {
            ...
            for (i = 1; i < tr.length; i++) {
                if (objx == i) {
                    if (come == "tr") {
                        tr[i].getElementsByTagName("td")[6].getElementsByTagName("input")[0].value = obj1;//ID
                    }
                    else if(come=="pg"){
                        tr[i].getElementsByTagName("td")[8].getElementsByTagName("input")[0].value = obj1;//ID
                    }
                    else if (come == "re") {
                        tr[i].getElementsByTagName("td")[7].getElementsByTagName("input")[0].value = obj1;//ID
                    }
                    else if (come == "sr") {
                        tr[i].getElementsByTagName("td")[7].getElementsByTagName("input")[0].value = obj1;//ID
                    }
