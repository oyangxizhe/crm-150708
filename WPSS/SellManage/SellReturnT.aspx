...
<div class ="c13111602" id="i13122801">
     ...
     <div class="c13122801" id ="Div36">
      <span style="color :#990033; margin-left :100px">
         注：由于销退含只销退金额不销退数量的需求，所以销退未税金额，销退税额，销退含税金额都需用户自己输入。销退数量与销退金额无直接关联</span>
</div>
           ...
           <asp:TemplateField HeaderText="ID" >
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox5" runat="server"  Text='<%#Eval ("EUJ料号") %>' ReadOnly ="true"  CssClass="c14071609" ></asp:TextBox>                     
                </ItemTemplate>
                    <HeaderStyle Width="3%" />
      ...
      <asp:TemplateField HeaderText="销退未税" >
                <ItemTemplate >
                 <asp:TextBox ID="TextBox23" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "销退未税金额", "{0:F2}")%>'  CssClass ="c13112012" ></asp:TextBox>                     
                </ItemTemplate>
               <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%" />
            </asp:TemplateField> 
                       <asp:TemplateField HeaderText="销退税额">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox24" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "销退税额", "{0:F2}")%>'  CssClass ="c13112012" ></asp:TextBox>                     
                </ItemTemplate>
                   <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  ForeColor="#595d5a"/>
            </asp:TemplateField> 
                       <asp:TemplateField HeaderText="销退含税">
                <ItemTemplate >
                 <asp:TextBox ID="TextBox25" runat="server" Text=' <%#DataBinder.Eval(Container.DataItem, "销退含税金额", "{0:F2}")%>' CssClass ="c13112012" ></asp:TextBox>                     
                </ItemTemplate>
                 <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%" />
            </asp:TemplateField> 
        ...
        <asp:TemplateField HeaderText="物料编码">
              ...
              <HeaderStyle Width="2%" />
                ...
                <ItemTemplate >
                 <asp:TextBox ID="TextBox26" runat="server" Text='<%#Eval ("工程费") %>'  CssClass ="c14071615" ></asp:TextBox>                     
                </ItemTemplate>
                <HeaderStyle Width="2%" />
                 <ItemStyle Width="2%"  />
            </asp:TemplateField>
   ...
   <input id="Text9" type="text"  runat ="server" class ="c13102908"  /> 
     ...
     <script type ="text/javascript" >
         ...
         function f13100202(obj, obj1) {
             var dlgResult;
             if (obj == "Text2") {
                 var url = "../SellManage/order.aspx?emid=" + document.getElementById("emid").value + "&come=sr";
                 ...
                 var url = "../StockManage/StorageInfo.aspx?obj1=" + obj1 + "&come=sr";
                 ...
                 if (navigator.userAgent.indexOf("Chrome") > 0) {
                     ...
                     for (i = 1; i < tr.length; i++) {
                      ...
                      var url = "../BaseInfo/EMPLOYEEINFO.aspx?come=sr";
                      var dlgResult = myShowModalDialog(url, window, 900, 500);
                      if (navigator.userAgent.indexOf("Chrome") > 0) {
